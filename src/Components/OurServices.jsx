...
const OurServices = () => {
  ...
  return (
    <div className='bg-gradient-to-r from-indigo-500 to-indigo-800 w-full xl:flex xl:justify-center xl:items-center'>
      <div className='xl:w xl:w-[1240px] mx-5'>
        <h1 className='text-white text-4xl p-5 font-bold text-center'>Our Services</h1>
        <div className='flex flex-col gap-4 items-center sm:grid sm:grid-cols-2'>
            <div onMouseEnter={() => setHover(1)} onMouseLeave={() => setHover(0)} className='w-full h-64 relative my-3  lg:h-72'>
            ...
            <div onMouseEnter={() => setHover(2)} onMouseLeave={() => setHover(0)} className='w-full h-64 relative my-3  lg:h-72'>
                <div className='w-full h-full rounded-xl '>
            ...
            <div onMouseEnter={() => setHover(3)} onMouseLeave={() => setHover(0)} className='w-full h-64 relative my-3  lg:h-72'>
                <div className='w-full h-full rounded-xl '>
            ...
            <div onMouseEnter={() => setHover(4)} onMouseLeave={() => setHover(0)} className='w-full h-64 relative my-3  lg:h-72'>
                <div className='w-full h-full rounded-xl '>
