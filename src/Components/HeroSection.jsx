...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center'>
      <div className="xl:w xl:w-[1240px] lg:flex lg:flex-row justify-between items-center h-auto flex-col w-full">
        <div className='flex flex-col gap-6 bg-gray-600 xl:w  xl:w-[50%] w-full py-10 text-white'>
        ...
        <div className='xl:w  xl:w-[50%] w-full h-96 bg-gray-600'>
